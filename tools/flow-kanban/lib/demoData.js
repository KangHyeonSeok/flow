...
const specs = [
  {
    ...
    meta: {
      title: '사용자 인증 시스템', type: '기능', status: '활성', attemptCount: 2,
      ...
      tests: [
        ...
        { id: 'T-002', type: 'E2E 테스트', conditionId: 'C-001', description: '로그인 페이지 E2E', lastResult: 'pass' },
      ],
  ...
  },
  {
    ...
    meta: {
      title: '사용자 프로필 관리', type: '기능', status: '작업', attemptCount: 1,
      updatedAt: '2026-03-12T02:15:00Z',
      conditions: [
        { id: 'C-001', description: '프로필 조회 API', status: '초안' },
        { id: 'C-002', description: '프로필 이미지 업로드', status: '초안' },
      ],
      tests: [
        { id: 'T-001', type: '단위 테스트', conditionId: 'C-001', description: '프로필 조회 테스트', lastResult: null },
        { id: 'T-002', type: '사용자 테스트', conditionId: 'C-002', description: '이미지 업로드 확인', lastResult: null },
      ],
    },
  ...
  },
  {
    ...
    meta: {
      title: '알림 시스템', type: '기능', status: '대기', attemptCount: 0,
      updatedAt: '2026-03-10T14:00:00Z',
      conditions: [{ id: 'C-001', description: '실시간 알림 WebSocket', status: '초안' }],
      tests: [],
    },
  ...
  },
  {
    ...
    meta: {
      title: '대시보드 위젯', type: '기능', status: '테스트 검증', attemptCount: 1,
  ...
  },
  {
    ...
    meta: {
      title: '검색 기능', type: '기능', status: '리뷰', attemptCount: 1,
      updatedAt: '2026-03-12T03:00:00Z',
      conditions: [{ id: 'C-001', description: '키워드 검색 API', status: '검증 완료' }],
      tests: [
        { id: 'T-001', type: '단위 테스트', conditionId: 'C-001', description: '검색 쿼리 테스트', lastResult: 'pass' },
        { id: 'T-002', type: '사용자 테스트', conditionId: 'C-001', description: '검색 결과 정확성 확인', lastResult: null },
      ],
    },
  ...
  },
  {
    ...
    meta: {
      title: 'CI/CD 파이프라인', type: '태스크', status: '검토', attemptCount: 3,
      updatedAt: '2026-03-11T22:00:00Z',
      conditions: [{ id: 'C-001', description: 'GitHub Actions 워크플로우', status: '검증 완료' }],
      tests: [{ id: 'T-001', type: '사용자 테스트', conditionId: 'C-001', description: '배포 스크립트 수동 검증', lastResult: null }],
  ...
  },
  {
    ...
    meta: {
      title: 'DB 마이그레이션 스크립트', type: '태스크', status: '완료', attemptCount: 1,
      updatedAt: '2026-03-09T16:00:00Z',
      conditions: [{ id: 'C-001', description: '마이그레이션 up/down 동작', status: '검증 완료' }],
      tests: [{ id: 'T-001', type: '단위 테스트', conditionId: 'C-001', description: '롤백 테스트', lastResult: 'pass' }],
    },
  ...
  },
  {
    ...
    meta: {
      title: '다국어 지원 (i18n)', type: '기능', status: '초안', attemptCount: 0,
  ...
  },
  {
    ...
    meta: {
      title: '결제 시스템 연동', type: '기능', status: '대기', attemptCount: 0,
      updatedAt: '2026-03-11T09:00:00Z',
      conditions: [
        { id: 'C-001', description: 'PG사 API 연동', status: '초안' },
        { id: 'C-002', description: '결제 취소 처리', status: '초안' },
      ],
      tests: [],
    },
  ...
  },
  {
    ...
    meta: {
      title: '주문 관리', type: '기능', status: '작업', attemptCount: 1,
      updatedAt: '2026-03-12T04:00:00Z',
      conditions: [{ id: 'C-001', description: '주문 생성 API', status: '초안' }],
      tests: [{ id: 'T-001', type: '단위 테스트', conditionId: 'C-001', description: '주문 생성 테스트', lastResult: null }],
    },
  ...
  },
  {
    ...
    meta: {
      title: '초기 DB 스키마 설계', type: '태스크', status: '완료', attemptCount: 1,
      updatedAt: '2026-03-08T10:00:00Z',
      conditions: [{ id: 'C-001', description: 'ERD 작성', status: '검증 완료' }],
      tests: [],
    },
